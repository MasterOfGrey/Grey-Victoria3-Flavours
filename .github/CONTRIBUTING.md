# Grey's Victoria 3 Flavours Contributing Guide
...
The goal I have with all of the mods in this collection is to create a dynamic and vibrant gameplay experience which either; improves the historicity of neglected parts of the world, adds historically plausible pathways to nations with limited content, or adds culturally meaningful touchstones to differentiate the experience of playing different countries. Importantly, also ensures that the AI can interact with all these things as functionally as possible.
